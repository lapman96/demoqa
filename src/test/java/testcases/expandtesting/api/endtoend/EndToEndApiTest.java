package testcases.expandtesting.api.endtoend;

import org.junit.jupiter.api.*;
import testcases.expandtesting.api.BaseExpandTestingApiTest;

import static com.expandtesting.data.JsonSchema.GET_NOTE_BY_ID_RESPONSE_JSON_SCHEMA;
import static com.expandtesting.data.TestData.REQUEST_PARAMS_FOR_DEFAULT_NOTE;
import static org.assertj.core.api.Assertions.assertThat;

@Tag("API")
class EndToEndApiTest extends BaseExpandTestingApiTest {
