...
public class PropertiesLoader {
    private static final String PATH_TO_COMMON_PROPERTIES = "common/common.properties";
    ...
    private static Properties loadEnvironmentSpecificProperties() {
        ...
        String propertyFilePath = String.format("%s/%s.properties",environment,environment);
